...
function SimpleSQS(options) {
  ...
  this.getQueueUrl = promisify(this.getQueueUrl)
  this.sendMessage = promisify(this.sendMessage)
  this.sendMessageBatch = promisify(this.sendMessageBatch)
  this.deleteMessage = promisify(this.deleteMessage)
  this.receiveMessage = promisify(this.receiveMessage)
  return this;
}
