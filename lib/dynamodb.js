...
function SimpleDynamoDB(options) {
  ...
  this.listTables = promisify(this.listTables)
  this.createTable = promisify(this.createTable);
  this.getItem = promisify(this.getItem);
  this.putItem = promisify(this.putItem);
  this.updateItem = promisify(this.updateItem);
  this.deleteItem = promisify(this.deleteItem);
  this.batchGetItem = promisify(this.batchGetItem);
  this.batchWriteItem = promisify(this.batchWriteItem);
  this.query = promisify(this.query);
  this.queryCount = promisify(this.queryCount);
  return this;
}
